    ...
    <DashboardCard className="h-full" delay={0.1} eyebrow="Progress" title="Processing pipeline">
      <div className="mb-4 flex items-end justify-between">
        <div>
          ...
          <p className="mt-2 text-[12px] font-medium text-white/42">Estimated finish in 1m 18s</p>
        </div>
        ...
        {steps.map((step) => {
          ...
          return (
            ...
            >
              ...
              <p className="truncate text-[12px] font-semibold text-white/82">{step.label}</p>
              <p className="mt-1 truncate text-[11px] font-medium text-white/36">{step.value}</p>
            </div>
          );
        })}
      </div>
