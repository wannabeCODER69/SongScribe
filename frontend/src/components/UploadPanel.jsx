      ...
      <div className="flex h-full flex-col justify-between">
        <div className="flex items-start justify-between gap-5">
          <div>
            ...
            <p className="mt-3 max-w-[430px] text-[13px] leading-5 text-white/48">
              MP3, WAV, M4A, FLAC, and AAC files are ready for fingerprinting, recognition, and
              transcription.
            </p>
          </div>
        ...
        >
          <span className="flex items-center gap-4">
            ...
            <span>
              <span className="block text-[15px] font-semibold text-white">Choose audio file</span>
